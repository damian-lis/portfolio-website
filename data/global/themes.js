export default {
  ...
  blue: {
    ...
    mainColorTransparent: 'rgba(21, 32, 43, 0.9)',

    secondaryColor: 'rgb(25, 39, 52)',
    secondaryColorTransparent: 'rgba(25, 39, 52, 0.9)',
  ...
  purple: {
    ...
    mainColorTransparent: 'rgba(70, 52, 78, 0.9)',

    secondaryColor: 'rgb(56, 42, 63)',
    secondaryColorTransparent: 'rgba(56, 42, 63, 0.9)',
